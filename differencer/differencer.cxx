...
int main(int argc, char *argv[])
{
   ...
   {
        unsigned char r_diff = std::abs((int) buffer1[3*i+0] - (int) buffer2[3*i+0]);
        unsigned char g_diff = std::abs((int) buffer1[3*i+1] - (int) buffer2[3*i+1]);
        unsigned char b_diff = std::abs((int) buffer1[3*i+2] - (int) buffer2[3*i+2]);
